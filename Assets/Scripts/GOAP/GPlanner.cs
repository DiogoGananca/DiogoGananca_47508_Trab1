...
public class aNode {
    ...
    // Constructor
    public aNode(aNode parent, float cost, Dictionary<string, int> allStates, GAction action) {
    ...
    public aNode(aNode parent, float cost, Dictionary<string, int> allStates, Dictionary<string, int> beliefStates, GAction action) {
...
public class GPlanner {
    ...
    public Queue<GAction> plan(List<GAction> actions, Dictionary<string, int> goal, WorldStates beliefStates) {
        ...
        List<aNode> leaves = new List<aNode>();
        aNode start = new aNode(null, 0.0f, GWorld.Instance.GetWorld().GetStates(), beliefStates.GetStates(), null);
    ...
    private bool BuildGraph(aNode parent, List<aNode> leaves, List<GAction> usableActions, Dictionary<string, int> goal) {
        ...
        foreach (GAction action in usableActions) {
            ...
            if (action.IsAhievableGiven(parent.state)) {
                ...
                aNode node = new aNode(parent, parent.cost + action.cost, currentState, action);
